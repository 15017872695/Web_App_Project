...
/*>>>*/
const ShoppingMall = () =>
    import ( /* webpackPrefetch: true */ '@/views/Home/ShoppingMall');
/*>>>*/
const ProductDetails = () =>
    import ( /* webpackChunkName: "ProductDetails" */ '@/views/Home/ShoppingMall/ProductDetails');

const Community = () =>
    import ( /* webpackChunkName: "Community" */ '@/views/Home/Community');
const Serve = () =>
    import ( /* webpackChunkName: "Serve" */ '@/views/Home/Serve');
const Consult = () =>
    import ( /* webpackChunkName: "Consult" */ '@/views/Home/Consult');
const Shop = () =>
    import ( /* webpackChunkName: "Shop" */ '@/views/Home/Shop');

const Classify = () =>
    import ( /* webpackChunkName: "Classify" */ '@/views/Classify');

const ShoppingCath = () =>
    import ( /* webpackChunkName: "ShoppingCath" */ '@/views/ShoppingCath');
